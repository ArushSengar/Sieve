...
object SmartAiClassifier {
    ...
    private val FINANCIAL_BAIT_TRIGGERS = listOf(
        ...
        Pair("earns between payments", "Earns Between Payments"),
        Pair("gold price dropped", "Gold Price Dropped"),
        Pair("gold price", "Gold Price Bait"),
        Pair("save in gold", "Save in Gold"),
        Pair("digital gold", "Digital Gold"),
        Pair("gold rate", "Gold Rate"),
        Pair("free gold", "Free Gold Bait"),
        Pair("claim gold", "Claim Gold"),
        Pair("buy gold", "Buy Gold Promo"),
        Pair("gold cashback", "Gold Cashback"),
        Pair("apna gullak", "Gullak Micro-savings"),
        Pair("gullak", "Gullak Micro-savings"),
        Pair("bachat", "Bachat Micro-savings"),
        Pair("save daily", "Daily Savings"),
        Pair("daily savings", "Daily Savings"),
        Pair("spare change", "Spare Change Savings"),
        Pair("round off", "Round Off Savings"),
        Pair("grow your money", "Grow Money Bait"),
        Pair("earn daily interest", "Daily Interest"),
        Pair("earn interest", "Earn Interest"),
        ...
        Pair("spin to win", "Spin to Win"),
        Pair("spin & win", "Spin & Win"),
        Pair("spin and win", "Spin & Win"),
        Pair("spin the wheel", "Spin the Wheel"),
        Pair("spin karo", "Spin Karo"),
        ...
        Pair("car insurance expiring", "Insurance Promo"),
        Pair("recharge now", "Recharge Promo"),
        Pair("recharge offer", "Recharge Offer"),
        Pair("student discount", "Student Discount")
    )
